...
const WhyChooseUs = () => {
 ...
 >
    <h2 className="text-3xl md:text-4xl font-bold text-[#d6b46d]"> Why Choose Us </h2>
    <p className="text-gray-400 mt-3 max-w-xl mx-auto"> We provide the best rental experience for tenants and property owners </p>
</motion.div>
