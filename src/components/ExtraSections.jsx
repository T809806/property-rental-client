...
const ExtraSections = () => {
  ...
  >
 <h2 className="text-3xl font-bold text-[#d6b46d]"> Top Locations </h2>
 <p className="text-gray-400 mt-2"> Popular cities for rental properties </p>
 </motion.div>
 ...
 <motion.div
        ...
        className="text-center mb-12"
      >
 <h2 className="text-3xl font-bold text-[#d6b46d]"> Rental Statistics </h2>
 <p className="text-gray-400 mt-2"> Platform performance overview </p>
 </motion.div>
 ...
 <h3 className="text-3xl font-bold text-[#d6b46d]"> {item.value} </h3>
